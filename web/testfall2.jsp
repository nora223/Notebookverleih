    ...
    <div> <!-- navigationsbereich Menu-->
        <div  class="row">
            ...
            <%
                ...
                //18 Ausleihen erstellen
                Ausleihe a1 = new Ausleihe();
                a1.setAntragssteller(s);
                ...
                a2.setAntragssteller(t);
                a2.setLeihNotebook(n2);
                a2.setMitarbeiter(e);
                a2.setDauer(90);
                a2.setAuftragsdatum(new Date());
                a2.setStatus(status);
                a2.setBetriebssystem("Windows");
                Date von1 = new Date();
                ...
                a3.setAntragssteller(u);
                a3.setLeihNotebook(n3);
                a3.setMitarbeiter(f);
                a3.setDauer(180);
                a3.setAuftragsdatum(new Date());
                a3.setStatus(status);
                a3.setBetriebssystem("Mac OS");
                Date von2 = new Date();
                GregorianCalendar cal2 = new GregorianCalendar();
                cal2.setTime(new Date());
                cal2.add(Calendar.DAY_OF_MONTH, 180);
                ...
                cal4.add(Calendar.DAY_OF_MONTH, 30);
                Date bis4 = cal4.getTime();
                a4.setVon(von4);
                a4.setBis(bis4);
                BL.Ausleihe.saveAusleihe(a4);
                
                Ausleihe a5 = new Ausleihe();
                a5.setAntragssteller(w);
                a5.setLeihNotebook(n5);
                a5.setMitarbeiter(e);
                a5.setDauer(90);
                a5.setAuftragsdatum(new Date());
                a5.setStatus(status);
                a5.setBetriebssystem("Windows");
                Date von5 = new Date();
                ...
                a8.setAntragssteller(z);
                a8.setLeihNotebook(n8);
                a8.setMitarbeiter(e);
                a8.setDauer(7);
                a8.setAuftragsdatum(new Date());
                a8.setStatus(status);
                a8.setBetriebssystem("Windows");
                Date von8 = new Date();
                ...
                a9.setAntragssteller(b);
                a9.setLeihNotebook(n9);
                a9.setMitarbeiter(f);
                a9.setDauer(30);
                a9.setAuftragsdatum(new Date());
                a9.setStatus(status);
                a9.setBetriebssystem("Mac OS");
                Date von9 = new Date();
                GregorianCalendar cal9 = new GregorianCalendar();
                cal9.setTime(new Date());
                cal9.add(Calendar.DAY_OF_MONTH, 30);
                Date bis9 = cal9.getTime();
                a9.setVon(von9);
                a9.setBis(bis9);
                BL.Ausleihe.saveAusleihe(a9);
                
                Ausleihe a10 = new Ausleihe();
                a10.setAntragssteller(c);
                a10.setLeihNotebook(n10);
                a10.setMitarbeiter(d);
                a10.setDauer(30);
                a10.setAuftragsdatum(new Date());
                a10.setStatus(status);
                a10.setBetriebssystem("Linux");
                Date von10 = new Date();
                GregorianCalendar cal10 = new GregorianCalendar();
                cal10.setTime(new Date());
                cal10.add(Calendar.DAY_OF_MONTH, 30);
                Date bis10 = cal10.getTime();
                a10.setVon(von10);
                a10.setBis(bis10);
                BL.Ausleihe.saveAusleihe(a10);
                
                Ausleihe a11 = new Ausleihe();
                a11.setAntragssteller(g);
                a11.setLeihNotebook(n11);
                a11.setMitarbeiter(e);
                a11.setDauer(90);
                a11.setAuftragsdatum(new Date());
                a11.setStatus(status);
                a11.setBetriebssystem("Windows");
                Date von11 = new Date();
                GregorianCalendar cal11 = new GregorianCalendar();
                cal11.setTime(new Date());
                cal11.add(Calendar.DAY_OF_MONTH, 90);
                Date bis11 = cal11.getTime();
                a11.setVon(von11);
                a11.setBis(bis11);
                BL.Ausleihe.saveAusleihe(a11);

                Ausleihe a12 = new Ausleihe();
                a12.setAntragssteller(h);
                a12.setLeihNotebook(n12);
                a12.setMitarbeiter(f);
                a12.setDauer(90);
                a12.setAuftragsdatum(new Date());
                a12.setStatus(status);
                a12.setBetriebssystem("Mac OS");
                Date von12 = new Date();
                GregorianCalendar cal12 = new GregorianCalendar();
                cal12.setTime(new Date());
                cal12.add(Calendar.DAY_OF_MONTH, 180);
                Date bis12 = cal12.getTime();
                a12.setVon(von12);
                a12.setBis(bis12);
                BL.Ausleihe.saveAusleihe(a12);
                
                Ausleihe a13 = new Ausleihe();
                a13.setAntragssteller(i);
                a13.setLeihNotebook(n13);
                a13.setMitarbeiter(d);
                a13.setDauer(7);
                a13.setAuftragsdatum(new Date());
                a13.setStatus(status);
                a13.setBetriebssystem("Linux");
                Date von13 = new Date();
                GregorianCalendar cal13 = new GregorianCalendar();
                cal13.setTime(new Date());
                cal13.add(Calendar.DAY_OF_MONTH, 7);
                Date bis13 = cal13.getTime();
                a13.setVon(von13);
                a13.setBis(bis13);
                BL.Ausleihe.saveAusleihe(a13);
                
                Ausleihe a14 = new Ausleihe();
                a14.setAntragssteller(j);
                a14.setLeihNotebook(n14);
                a14.setMitarbeiter(e);
                a14.setDauer(7);
                a14.setAuftragsdatum(new Date());
                a14.setStatus(status);
                a14.setBetriebssystem("Windows");
                Date von14 = new Date();
                GregorianCalendar cal14 = new GregorianCalendar();
                cal14.setTime(new Date());
                cal14.add(Calendar.DAY_OF_MONTH, 7);
                Date bis14 = cal14.getTime();
                a14.setVon(von14);
                a14.setBis(bis14);
                BL.Ausleihe.saveAusleihe(a14);

                Ausleihe a15 = new Ausleihe();
                a15.setAntragssteller(k);
                a15.setLeihNotebook(n15);
                a15.setMitarbeiter(f);
                a15.setDauer(30);
                a15.setAuftragsdatum(new Date());
                a15.setStatus(status);
                a15.setBetriebssystem("Mac OS");
                Date von15 = new Date();
                GregorianCalendar cal15 = new GregorianCalendar();
                cal15.setTime(new Date());
                cal15.add(Calendar.DAY_OF_MONTH, 30);
                Date bis15 = cal15.getTime();
                a15.setVon(von15);
                a15.setBis(bis15);
                BL.Ausleihe.saveAusleihe(a15);
                
                Ausleihe a16 = new Ausleihe();
                a16.setAntragssteller(l);
                a16.setLeihNotebook(n16);
                a16.setMitarbeiter(d);
                a16.setDauer(30);
                a16.setAuftragsdatum(new Date());
                a16.setStatus(status);
                a16.setBetriebssystem("Linux");
                Date von16 = new Date();
                GregorianCalendar cal16 = new GregorianCalendar();
                cal16.setTime(new Date());
                cal16.add(Calendar.DAY_OF_MONTH, 30);
                Date bis16 = cal16.getTime();
                a16.setVon(von16);
                a16.setBis(bis16);
                BL.Ausleihe.saveAusleihe(a16);
                
                Ausleihe a17 = new Ausleihe();
                a17.setAntragssteller(m);
                a17.setLeihNotebook(n17);
                a17.setMitarbeiter(e);
                a17.setDauer(90);
                a17.setAuftragsdatum(new Date());
                a17.setStatus(status);
                a17.setBetriebssystem("Windows");
                Date von17 = new Date();
                GregorianCalendar cal17 = new GregorianCalendar();
                cal17.setTime(new Date());
                cal17.add(Calendar.DAY_OF_MONTH, 90);
                Date bis17 = cal17.getTime();
                a17.setVon(von17);
                a17.setBis(bis17);
                BL.Ausleihe.saveAusleihe(a17);

                Ausleihe a18 = new Ausleihe();
                a18.setAntragssteller(n);
                a18.setLeihNotebook(n18);
                a18.setMitarbeiter(f);
                a18.setDauer(90);
                a18.setAuftragsdatum(new Date());
                a18.setStatus(status);
                a18.setBetriebssystem("Mac OS");
                Date von18 = new Date();
                GregorianCalendar cal18 = new GregorianCalendar();
                cal18.setTime(new Date());
                cal18.add(Calendar.DAY_OF_MONTH, 180);
                Date bis18 = cal18.getTime();
                a18.setVon(von18);
                a18.setBis(bis18);
                BL.Ausleihe.saveAusleihe(a18);
